...
<div class=column>
         <div class=card>
            <img src=muffins.jpg style=width:150px;height:150px>
            <b><p>Muffins<p></b>
            <b><p>$2.59</p></b> 
...
foreach ($result as $result) {
  ...
  <div class=column>
           ...
           <img src=$result[dairyimg] style=width:150px;height:150px>
              ...
              <b><p><label for=bakeryname>$result[bakeryname]</label></p></b>
              <input type=hidden id=bakeryname name=productname value=$result[bakeryname]>
  
              <b><p><label for=price>$result[bakeryprice]</label></p></b>
              <input type=hidden id=price name=productprice value=$result[bakeryprice]>
